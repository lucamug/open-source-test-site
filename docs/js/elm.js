							...
							_List_fromArray(
								[
										...
										]),
									{
										label: A3(
											author$project$Internal$Icon$icon,
											author$project$Internal$Icon$Icon_PlusL,
											A2(
												author$project$Conf$c,
												model,
												function ($) {
...
var author$project$Internal$Icon$Icon_Grid = {$: 'Icon_Grid'};
var author$project$Internal$Icon$Icon_Row = {$: 'Icon_Row'};
var author$project$Internal$Msg$ChangeFilter = function (a) {
	return {$: 'ChangeFilter', a: a};
};
var author$project$Internal$Msg$ToggleLayoutMode = {$: 'ToggleLayoutMode'};
							...
							_List_Nil,
							{
								label: A3(
									...
									function () {
										...
										if (_n0.$ === 'Grid') {
											return author$project$Internal$Icon$Icon_Row;
										} else {
											return author$project$Internal$Icon$Icon_Grid;
										}
									}(),
									A2(
										author$project$Conf$c,
									...
									author$project$Conf$iconSize),
								onPress: elm$core$Maybe$Just(author$project$Internal$Msg$ToggleLayoutMode)
							})
						]))
				])));
};
