...
{
	if (region.bn.af === region.bJ.af)
	{
		return 'on line ' + region.bn.af;
	}
	return 'on lines ' + region.bn.af + ' through ' + region.bJ.af;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.aZ.a));
		});

		try
		{
			xhr.open(request.bf, request.fa, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.fa)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		fa: xhr.responseURL,
		eG: { c6: xhr.status, E: xhr.statusText },
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				(title !== doc.e1) && (_VirtualDom_doc.title = title = doc.e1);
			});
		}
	);
});
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dy: 'hidden', c1: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dy: 'mozHidden', c1: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dy: 'msHidden', c1: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dy: 'webkitHidden', c1: 'webkitvisibilitychange' }
		: { dy: 'hidden', c1: 'visibilitychange' };
}
...
var author$project$Internal$Type$Repo = F6(
	function (name, description, fork, updated_at, homepage, language) {
		return {df: description, ds: fork, dz: homepage, dR: language, dZ: name, e9: updated_at};
	});
...
var lukewestby$elm_http_builder$HttpBuilder$requestWithMethodAndUrl = F2(
	function (method, url) {
		return {
			cQ: elm$http$Http$emptyBody,
			r: elm$core$Maybe$Nothing,
			aZ: elm$http$Http$expectStringResponse(
				function (_n0) {
...
var lukewestby$elm_http_builder$HttpBuilder$requestUrl = function (builder) {
	...
	var fullUrl = elm$core$String$isEmpty(encodedParams) ? builder.fa : (builder.fa + ('?' + encodedParams));
	return fullUrl;
};
	...
	return elm$http$Http$request(
		{
			...
			bf: builder.bf,
			bq: builder.bq,
			fa: lukewestby$elm_http_builder$HttpBuilder$requestUrl(builder),
			bu: builder.bu
		});
};
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.cQ);
			if (_n0.$ === 1) {
...
var lukewestby$elm_http_builder$HttpBuilder$withExpectJson = F2(
	function (decoder, builder) {
		return {
			cQ: builder.cQ,
			r: builder.r,
			aZ: elm$http$Http$expectJson(decoder),
			aA: builder.aA,
			bf: builder.bf,
			p: builder.p,
			bq: builder.bq,
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {L: frag, Q: params, I: unvisited, A: value, U: visited};
	});
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					elm$url$Url$Parser$preparePath(url.ek),
	...
	function (conf, url) {
		return A2(
			...
			_Utils_update(
				url,
				{
					ek: A2(elm$core$Maybe$withDefault, '', url.dt)
				}));
	});
...
var author$project$Internal$Route$urlLabel = {$7: 'filter', ba: 'keyword', bc: 'link', bj: 'person'};
	...
	_List_fromArray(
		[
			...
			A2(
				...
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.bc),
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.ba),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.bj),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.$7),
				elm$url$Url$Parser$string))
		]));
	...
	var pieces = function () {
		switch (route.$) {
			...
			case 1:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.bc, id]);
			case 3:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.ba, id]);
			case 2:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.bj, id]);
			default:
				var filter = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.$7, filter]);
		}
	}();
	return _Utils_eq(pieces, _List_Nil) ? '' : ('/' + A2(elm$core$String$join, '/', pieces));
};
var author$project$Internal$Route$conf = {dg: author$project$Internal$Route$Empty, ei: author$project$Internal$Route$parser, e2: author$project$Internal$Route$toString};
var author$project$Internal$Type$Day = 0;
...
var author$project$Internal$Init$init = F3(
	function (flags, url, key) {
		...
		return _Utils_Tuple2(
			{c9: 0, $7: filter, dQ: key, dS: 1, eh: true, eo: elm$core$Maybe$Nothing, fa: url, cs: flags.cs},
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dt: fragment, bR: host, ek: path, b6: port_, b9: protocol, ca: query};
	});
...
var author$project$Internal$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 9:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							eo: elm$core$Maybe$Just(response)
						}),
			...
			case 0:
				var data = msg.a;
				return (data.dC === 'cover') ? _Utils_Tuple2(
					model,
...
var author$project$Conf$colorPalette = function (colorMode) {
	if (colorMode === 1) {
		return {
			aT: A3(mdgriffith$elm_ui$Element$rgb, 0.2, 0.2, 0.2),
			aV: A3(mdgriffith$elm_ui$Element$rgb, 0.2, 0.2, 0.2),
			a_: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8),
			a$: A3(mdgriffith$elm_ui$Element$rgb, 0.5, 0.5, 0.5),
			a0: A3(mdgriffith$elm_ui$Element$rgb255, 20, 20, 20),
			a1: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
			a2: A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153),
			bd: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200)
		};
	} else {
		return {
			aT: A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1),
			aV: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8),
			a_: A3(mdgriffith$elm_ui$Element$rgb, 0.3, 0.3, 0.3),
			a$: A3(mdgriffith$elm_ui$Element$rgb, 0.4, 0.4, 0.4),
			a0: A3(mdgriffith$elm_ui$Element$rgb255, 51, 51, 51),
			a1: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
			a2: A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153),
			bd: A3(mdgriffith$elm_ui$Element$rgb255, 191, 0, 0)
		};
	}
};
var author$project$Conf$c = F2(
	function (model, key) {
		return key(
			author$project$Conf$colorPalette(model.c9));
	});
...
var mdgriffith$elm_ui$Internal$Style$classes = {cw: 'a', aP: 'atv', cz: 'ab', cA: 'cx', cB: 'cy', cC: 'acb', cD: 'accx', cE: 'accy', cF: 'acr', bx: 'al', by: 'ar', cG: 'at', aQ: 'ah', aR: 'av', cI: 's', cM: 'bh', cN: 'b', cR: 'w7', cT: 'bd', cU: 'bdt', ar: 'bn', cV: 'bs', as: 'cpe', c3: 'cp', c4: 'cpx', c5: 'cpy', C: 'c', au: 'ctr', av: 'cb', aw: 'ccx', D: 'ccy', ad: 'cl', ax: 'cr', da: 'ct', db: 'cptr', dc: 'ctxt', dr: 'fcs', du: 'fs', dw: 'g', a4: 'hbh', aB: 'hc', a5: 'hf', bQ: 'hfp', dA: 'hv', dH: 'ic', dJ: 'fr', dN: 'iml', dO: 'it', dP: 'i', Y: 'nb', b0: 'notxt', d9: 'ol', eb: 'or', P: 'oq', eg: 'oh', b3: 'pg', b4: 'p', ej: 'ppe', er: 'ui', u: 'r', eu: 'sb', ev: 'sbx', ew: 'sby', ex: 'sbt', ez: 'e', eB: 'cap', eC: 'sev', eJ: 'sk', eO: 't', eP: 'tc', eQ: 'w8', eR: 'w2', eS: 'w9', eT: 'tj', aL: 'tja', eU: 'tl', eV: 'w3', eW: 'w5', eX: 'w4', eY: 'tr', eZ: 'w6', e_: 'w1', e$: 'tun', co: 'ts', T: 'clr', e7: 'u', bs: 'wc', ct: 'we', bt: 'wf', cu: 'wfp', bv: 'wrp'};
...
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.cI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dw);
...
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.cI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ez);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.w)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eD.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eD.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.u) + ('-' + (elm$core$String$fromInt(pos.c7) + ('-' + (elm$core$String$fromInt(pos.cs) + ('-' + elm$core$String$fromInt(pos.X)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.d7.a) + 'px'),
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.d7.b) + 'px'),
					elm$core$Maybe$Just(
							...
							mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									d7: A2(
										...
										A2(elm$core$Tuple$mapFirst, elm$core$Basics$toFloat, shadow.d7)),
									eA: shadow.eA
								}));
					},
					focus.ey),
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.T)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dA, mdgriffith$elm_ui$Internal$Style$classes.P)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dr, mdgriffith$elm_ui$Internal$Style$classes.T)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dr, mdgriffith$elm_ui$Internal$Style$classes.P)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aP, mdgriffith$elm_ui$Internal$Style$classes.T)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aP, mdgriffith$elm_ui$Internal$Style$classes.P)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cI) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cI) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cI) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cI) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.au) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {at: closing, h: _List_Nil, H: _List_Nil, z: selector};
	});
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.z + ('{' + (renderValues(rule.H) + (rule.at + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.eB + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.eO + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.eB + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.eO)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {X: height / size, eA: size, cq: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.c0, adjustment.cL, adjustment.de, adjustment.dV]);
	var lineHeight = 1.5;
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var single = '.' + mdgriffith$elm_ui$Internal$Style$classes.ez;
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.u) + (' / ' + (elm$core$String$fromInt(position.u + position.X) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.c7) + (' / ' + (elm$core$String$fromInt(position.c7 + position.cs) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.u) + ('-' + (elm$core$String$fromInt(position.c7) + ('-' + (elm$core$String$fromInt(position.cs) + ('-' + elm$core$String$fromInt(position.X)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.cI + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ez))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.au, mdgriffith$elm_ui$Internal$Style$classes.D, mdgriffith$elm_ui$Internal$Style$classes.cF])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.au, mdgriffith$elm_ui$Internal$Style$classes.D, mdgriffith$elm_ui$Internal$Style$classes.cD])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.au, mdgriffith$elm_ui$Internal$Style$classes.cE])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.au, mdgriffith$elm_ui$Internal$Style$classes.cC])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.eO, mdgriffith$elm_ui$Internal$Style$classes.bs, mdgriffith$elm_ui$Internal$Style$classes.aB])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.eO, mdgriffith$elm_ui$Internal$Style$classes.bt, mdgriffith$elm_ui$Internal$Style$classes.a5])))
			]),
		_List_fromArray(
			[
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.cw]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.cN]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.eb]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.d9]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.dJ]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.Y, mdgriffith$elm_ui$Internal$Style$classes.ez, mdgriffith$elm_ui$Internal$Style$classes.cM]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bx);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.by);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cA);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cB);
	}
};
...
var author$project$Internal$Icon$Icon_PlusL = 3;
...
var avh4$elm_color$Color$fromRgba = function (components) {
	return A4(avh4$elm_color$Color$RgbaSpace, components.bl, components.a3, components.aU, components.V);
};
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.da + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ad)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.aw + (' ' + mdgriffith$elm_ui$Internal$Style$classes.D)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.aw + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.D + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.ex + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b0)))))),
						A2(
							elm$core$List$cons,
				...
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												s: mdgriffith$elm_ui$Element$text('Rakuten Technology'),
												fa: 'https://github.com/rakutentech'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												s: mdgriffith$elm_ui$Element$text('Rakuten Front-end'),
												fa: 'https://github.com/rakuten-frontend'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												s: mdgriffith$elm_ui$Element$text('Rakuten Web Service'),
												fa: 'https://github.com/rakuten-ws'
											})
										])),
									A2(
									mdgriffith$elm_ui$Element$el,
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												s: mdgriffith$elm_ui$Element$text('Rakuten Developers'),
												fa: 'https://webservice.rakuten.co.jp/'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												s: mdgriffith$elm_ui$Element$text('Rakuten RapidAPI'),
												fa: 'https://api.rakuten.co.jp/'
											})
										]))
								])),
							A2(
								...
								[
										...
										[mdgriffith$elm_ui$Element$alignRight]),
									{
										s: A3(
											...
											32),
										fa: 'https://global.rakuten.com/corp/'
									}),
									A2(
									mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										...
										]),
									{
										...
										ea: elm$core$Maybe$Just(author$project$Internal$Msg$ToggleColorMode)
									})
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							{
								s: mdgriffith$elm_ui$Element$text('About'),
								fa: 'https://global.rakuten.com/corp/'
							}),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								s: mdgriffith$elm_ui$Element$text('Careers'),
								fa: 'https://rakuten.careers/'
							}),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								s: mdgriffith$elm_ui$Element$text('Contact'),
								fa: 'mailto:dev-opensource@mail.rakuten.com'
							})
						]))
				])));
};
...
var author$project$Internal$Icon$Icon_Grid = 7;
var author$project$Internal$Icon$Icon_Row = 8;
var author$project$Internal$Msg$ChangeFilter = function (a) {
	return {$: 4, a: a};
};
var author$project$Internal$Msg$ToggleLayoutMode = {$: 3};
...
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {cP: almostShade.cP, c8: almostShade.c8, bV: false, d7: almostShade.d7, eA: almostShade.eA};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
		...
		var _n0 = function () {
			...
			if (!_n1.$) {
				...
				var _n3 = A3(
					...
					{k: _List_Nil, aB: elm$core$Maybe$Nothing, aE: elm$core$Maybe$Nothing, aF: elm$core$Maybe$Nothing, aG: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.aF;
				var heightContent = _n3.aB;
				var maybeSpacing = _n3.aG;
				var adjustedAttributes = _n3.k;
				var maybeBorder = _n3.aE;
							...
							[
								...
								if (maybePadding.$ === 1) {
									...
									return mdgriffith$elm_ui$Element$paddingEach(
										{
											cW: A2(elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											dT: l,
											eq: r,
											e3: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4(mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.eO, spacing, maybePadding, maybeBorder);
									} else {
										return mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ej)),
		...
		_Utils_ap(
			...
			model.eh ? _List_fromArray(
				...
				[
					...
					{
						cP: 10,
						c8: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2),
						d7: _Utils_Tuple2(0, 0),
						eA: 5
					})
				])),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								s: A2(mdgriffith$elm_ui$Element$Input$labelAbove, _List_Nil, mdgriffith$elm_ui$Element$none),
								d8: author$project$Internal$Msg$ChangeFilter,
								...
								eO: author$project$Internal$Utils$decode(model.$7)
							}),
							(elm$core$String$length(model.$7) > 0) ? A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_Nil,
							{
								s: A3(
							...
							_List_Nil,
							{
								s: A3(
									...
									author$project$Conf$iconSize),
								ea: elm$core$Maybe$Just(author$project$Internal$Msg$ToggleLayoutMode)
							})
						]))
				])));
};
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$text(
						elm$core$String$fromInt(index + 1) + ('. ' + repo.dZ))),
					mdgriffith$elm_ui$Element$text(repo.df),
					mdgriffith$elm_ui$Element$text(
					repo.ds ? 'True' : 'False'),
					mdgriffith$elm_ui$Element$text(repo.e9),
					mdgriffith$elm_ui$Element$text(repo.dz),
					mdgriffith$elm_ui$Element$text(repo.dR)
				]));
	});
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{dr: elm$core$Maybe$Nothing, dA: elm$core$Maybe$Nothing, dY: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.er, mdgriffith$elm_ui$Internal$Style$classes.cI, mdgriffith$elm_ui$Internal$Style$classes.ez]))),
...
var author$project$Internal$View$view = function (model) {
	var route = A2(author$project$Internal$CommonRoute$fromUrl, author$project$Internal$Route$conf, model.fa);
			...
			[
				...
				mdgriffith$elm_ui$Element$layoutWith,
				{
					ef: _List_fromArray(
						[
							...
							{cK: elm$core$Maybe$Nothing, cS: elm$core$Maybe$Nothing, ey: elm$core$Maybe$Nothing})
						])
				},
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$paddingEach(
							{cW: 0, dT: 0, eq: 0, e3: author$project$Conf$headerHeight}),
					...
					_List_fromArray(
						[
							...
							A2(
								...
								{df: 'Coding...', eF: 'img/background2.png'})),
							A2(
							mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
							...
							function () {
								...
								if (!_n0.$) {
									...
									if (!result.$) {
										...
										return A2(
											...
											A2(
												...
												F2(
													function (index, repo) {
														return A3(author$project$ViewRepo$view, model, index, repo);
													}),
												repos));
									} else {
										var err = result.a;
									...
									return mdgriffith$elm_ui$Element$text('Loading Repos');
								}
							}()),
							A2(
							mdgriffith$elm_ui$Element$el,
...
var author$project$Internal$Main$main = elm$browser$Browser$application(
	{
		dL: author$project$Internal$Init$init,
		ec: author$project$Internal$Msg$UrlChanged,
		ed: author$project$Internal$Msg$LinkClicked,
		eL: function (model) {
		...
		e8: author$project$Internal$Update$update,
		fb: author$project$Internal$View$view
	});
