...
var author$project$Internal$Type$Repo = F8(
	function (name, description, fork, updated_at, homepage, language, html_url, logo) {
		return {description: description, fork: fork, homepage: homepage, html_url: html_url, language: language, logo: logo, name: name, updated_at: updated_at};
	});
...
var author$project$Internal$Route$urlLabel = {filter: 'filter', keyword: 'keyword', link: 'link', person: 'person'};
	...
	_List_fromArray(
		[
			...
			A2(
				...
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.link),
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.keyword),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.person),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			...
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.filter),
				elm$url$Url$Parser$string))
		]));
	...
	var pieces = function () {
		switch (route.$) {
			...
			case 'SelectedLink':
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.link, id]);
			case 'SelectedKeyword':
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.keyword, id]);
			case 'SelectedPerson':
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.person, id]);
			default:
				var filter = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.filter, filter]);
		}
	}();
...
var author$project$Repos$repos = _List_fromArray(
	[
		{description: 'Provides information about items listed for sale on Rakuten sites, shopping cart, and other functionality for use by developers and corporate enterprise teams.', fork: false, homepage: 'http://webservice.rakuten.co.jp/sdk/', html_url: 'https://github.com/rakuten-ws/', language: '', logo: '', name: 'Rakuten Web Service', updated_at: ''},
		{description: 'LeoFS is an unstructured object/data storage for the Web and a highly available, distributed, eventually consistent storage system.', fork: false, homepage: 'http://leo-project.net/leofs/', html_url: 'https://github.com/leo-project/leofs', language: '', logo: 'logo/leofs.png', name: 'LeoFS', updated_at: ''},
		{description: 'A Distributed Key-Value Store in Ruby.', fork: false, homepage: 'http://roma-kvs.org/', html_url: 'https://github.com/roma/roma', language: '', logo: 'logo/roma.png', name: 'ROMA', updated_at: ''},
		{description: 'Egison is a purely functional programming language that realizes non-linear pattern-matching against unfree data types.', fork: false, homepage: 'http://www.egison.org/', html_url: 'https://github.com/egison/egison', language: '', logo: '', name: 'Egison', updated_at: ''}
	]);
		...
		return _Utils_Tuple2(
			{
				...
				filter: filter,
				indexForRepo: author$project$Internal$Search$indexBuilderforRepo(author$project$Repos$repos),
				key: key,
				layoutMode: author$project$Internal$Type$Grid,
				localStorage: flags.localStorage,
				pageInTopArea: true,
				repos: author$project$Repos$repos,
				url: url,
				width: flags.width
			},
	...
	var json = elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nightMode',
				elm$json$Json$Encode$bool(data.nightMode))
			]));
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotData':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							error: error,
							indexForRepo: author$project$Internal$Search$indexBuilderforRepo(repos),
							repos: repos
						}),
					elm$core$Platform$Cmd$none);
			case 'LinkClicked':
			...
			case 'ToggleColorMode':
				var localStorage = model.localStorage;
...
var author$project$Conf$colorPalette = function (nightMode) {
	return nightMode ? {
		background: A3(mdgriffith$elm_ui$Element$rgb, 0.1, 0.1, 0.1),
		...
		footerBackground: A3(mdgriffith$elm_ui$Element$rgb255, 40, 40, 40),
		...
		repoBackground: A3(mdgriffith$elm_ui$Element$rgb, 0.18, 0.18, 0.18),
		repoShadow: A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0)
	} : {
		background: A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1),
		...
		footerFont: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
		footerFontLight: A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153),
		logo: A3(mdgriffith$elm_ui$Element$rgb255, 191, 0, 0),
		repoBackground: A3(mdgriffith$elm_ui$Element$rgb, 0.97, 0.97, 0.97),
		repoShadow: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8)
	};
};
var author$project$Internal$Utils$c = F2(
	function (model, key) {
		return key(
			author$project$Conf$colorPalette(model.localStorage.nightMode));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						model.localStorage.nightMode ? 'img/backgroundDark.png' : 'img/backgroundBright.png')
					]),
...
var author$project$Internal$Search$filteredRepos = function (model) {
	var searchResults = A2(
		...
		A2(
			...
			model.indexForRepo,
			author$project$Internal$Utils$decode(model.filter)));
			...
			return A2(
				...
				function (item) {
					...
					return A2(
						elm$core$List$filter,
						function (item_) {
							return _Utils_eq(item_.name, id);
						},
						model.repos);
				},
				result);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							(repo.logo === '') ? mdgriffith$elm_ui$Element$none : A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$alignLeft,
							...
							A2(
								...
								{description: 'Logo', src: repo.logo})),
							mdgriffith$elm_ui$Element$text(repo.name)
						])),
					A2(
					mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					...
					(repo.homepage === '') ? mdgriffith$elm_ui$Element$none : A2(
					...
					(repo.language === '') ? mdgriffith$elm_ui$Element$none : A2(
					mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
						[mdgriffith$elm_ui$Element$alignBottom]),
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Language: ' + repo.language)
						]))
				]));
	});
var author$project$Internal$View$repoCell = F2(
	function (model, repo) {
		return A2(
			...
			{
				label: A3(author$project$ViewRepo$view, model, 0, repo),
				url: repo.html_url
			});
	});
	...
	return A2(
		...
		(!length) ? _List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text('No Repositories found for the filter \"' + (model.filter + '\"')))
			]) : _Utils_ap(
			_List_fromArray(
				[
					A2(
			...
			A2(
				(model.width < 600) ? author$project$Internal$View$viewFirstOne : ((model.width < 900) ? author$project$Internal$View$viewFirstTwo : author$project$Internal$View$viewFirstThree),
				model,
				repos)));
};
var author$project$Internal$Icon$Logo_Rakuten = {$: 'Logo_Rakuten'};
...
var author$project$Internal$Msg$ToggleColorMode = {$: 'ToggleColorMode'};
				...
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text('Rakuten Technology'),
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text('Rakuten Front-end'),
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text('Rakuten Web Service'),
												url: 'https://github.com/rakuten-ws'
											})
										])),
									A2(
									mdgriffith$elm_ui$Element$el,
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text('Rakuten Developers'),
											...
											_List_Nil,
											{
												label: mdgriffith$elm_ui$Element$text('Rakuten RapidAPI'),
												url: 'https://api.rakuten.co.jp/'
											})
										]))
								])),
							A2(
								...
								[
										...
										[alignR]),
									{
										label: A3(
											...
											author$project$Internal$Icon$Logo_Rakuten,
											A2(
												author$project$Internal$Utils$c,
												model,
												function ($) {
										...
										]),
									{
															...
															A2(
																...
																_List_fromArray(
																	[
																		...
																		model.localStorage.nightMode ? 32 : 3),
										...
										onPress: elm$core$Maybe$Just(author$project$Internal$Msg$ToggleColorMode)
									})
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							{
								label: mdgriffith$elm_ui$Element$text('Careers'),
							...
							_List_Nil,
							{
								...
								url: 'mailto:dev-opensource@mail.rakuten.com'
							})
						]))
				])));
};
...
var author$project$Internal$Icon$Icon_Close = {$: 'Icon_Close'};
		...
		_List_fromArray(
			[
					...
					]),
				{
					...
					onChange: author$project$Internal$Msg$ChangeFilter,
				...
				_List_Nil,
				{
					label: A3(
						author$project$Internal$Icon$icon,
						author$project$Internal$Icon$Icon_Close,
						A2(
							author$project$Internal$Utils$c,
							model,
							function ($) {
...
var author$project$Internal$Icon$Logo_R = {$: 'Logo_R'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(
					author$project$Internal$Icon$icon,
					author$project$Internal$Icon$Logo_R,
					A2(
						author$project$Internal$Utils$c,
						model,
						function ($) {
				...
				A3(
					...
					30)),
				(author$project$Internal$Utils$isMobile(model) && (model.filter !== '')) ? mdgriffith$elm_ui$Element$none : A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$color(
...
var author$project$ViewHeader$view = function (model) {
	return A2(
		...
		_Utils_ap(
			...
			model.pageInTopArea ? _List_fromArray(
				[
					mdgriffith$elm_ui$Element$height(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							(model.filter === '') ? author$project$Internal$View$viewIntroduction(model) : mdgriffith$elm_ui$Element$none,
			...
			return A2(
				...
				function (localStorage) {
					return elm$json$Json$Decode$succeed(
						{localStorage: localStorage, width: width});
				},
				A2(
					elm$json$Json$Decode$field,
					'localStorage',
