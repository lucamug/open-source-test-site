...
{
	if (region.bl.ad === region.bH.ad)
	{
		return 'on line ' + region.bl.ad;
	}
	return 'on lines ' + region.bl.ad + ' through ' + region.bH.ad;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.ba, request.fg, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.fg)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	elm$core$Maybe$isJust(request.bo) && (xhr.timeout = request.bo.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		fg: xhr.responseURL,
		eL: { c2: xhr.status, D: xhr.statusText },
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				(title !== doc.e6) && (_VirtualDom_doc.title = title = doc.e6);
			});
		}
	);
});
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dw: 'hidden', cZ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dw: 'mozHidden', cZ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dw: 'msHidden', cZ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dw: 'webkitHidden', cZ: 'webkitvisibilitychange' }
		: { dw: 'hidden', cZ: 'visibilitychange' };
}
...
var author$project$Internal$Type$Repo = F8(
	function (name, description, fork, updated_at, homepage, language, html_url, logo) {
		return {da: description, dq: fork, dx: homepage, dA: html_url, dU: language, a8: logo, bc: name, ff: updated_at};
	});
...
var lukewestby$elm_http_builder$HttpBuilder$requestUrl = function (builder) {
	var encodedParams = lukewestby$elm_http_builder$HttpBuilder$joinUrlEncoded(builder.p);
	var fullUrl = elm$core$String$isEmpty(encodedParams) ? builder.fg : (builder.fg + ('?' + encodedParams));
	return fullUrl;
};
	...
	return elm$http$Http$request(
		{
			...
			ba: builder.ba,
			bo: builder.bo,
			fg: lukewestby$elm_http_builder$HttpBuilder$requestUrl(builder),
			bs: builder.bs
		});
};
...
var lukewestby$elm_http_builder$HttpBuilder$withQueryParams = F2(
	function (queryParams, builder) {
		return _Utils_update(
			builder,
			{
				p: _Utils_ap(builder.p, queryParams)
			});
	});
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.cM);
			if (_n0.$ === 1) {
...
var lukewestby$elm_http_builder$HttpBuilder$withExpectJson = F2(
	function (decoder, builder) {
		return {
			cM: builder.cM,
			r: builder.r,
			aV: elm$http$Http$expectJson(decoder),
			ay: builder.ay,
			ba: builder.ba,
			p: builder.p,
			bo: builder.bo,
...
var author$project$Internal$APIRequest$request = A2(
	lukewestby$elm_http_builder$HttpBuilder$send,
	author$project$Internal$Msg$GotData,
	A2(
		lukewestby$elm_http_builder$HttpBuilder$withExpectJson,
		author$project$Internal$APIRequest$decoderBody,
		lukewestby$elm_http_builder$HttpBuilder$get('test-api/repos.json')));
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {K: frag, P: params, H: unvisited, z: value, T: visited};
	});
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					elm$url$Url$Parser$preparePath(url.eo),
					elm$url$Url$Parser$prepareQuery(url.b7),
					url.dr,
					elm$core$Basics$identity)));
	});
var author$project$Internal$CommonRoute$urlToMaybeRoute = F2(
	function (conf, url) {
		return A2(
			...
			_Utils_update(
				url,
				{
					eo: A2(elm$core$Maybe$withDefault, '', url.dr)
				}));
	});
var author$project$Internal$CommonRoute$fromUrl = F2(
	function (conf, url) {
		return A2(
...
var author$project$Internal$Route$Empty = {$: 0};
var author$project$Internal$Route$Filter = function (a) {
	return {$: 4, a: a};
};
var author$project$Internal$Route$SelectedKeyword = function (a) {
	return {$: 3, a: a};
};
var author$project$Internal$Route$SelectedLink = function (a) {
	return {$: 1, a: a};
};
var author$project$Internal$Route$SelectedPerson = function (a) {
	return {$: 2, a: a};
};
var author$project$Internal$Route$urlLabel = {dl: 'filter', a5: 'keyword', a7: 'link', bf: 'person'};
...
var author$project$Internal$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			elm$url$Url$Parser$map,
			author$project$Internal$Route$SelectedLink,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.a7),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Internal$Route$SelectedKeyword,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.a5),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Internal$Route$SelectedPerson,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.bf),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Internal$Route$Filter,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s(author$project$Internal$Route$urlLabel.dl),
				elm$url$Url$Parser$string))
		]));
var author$project$Internal$Route$toString = function (route) {
	var pieces = function () {
		switch (route.$) {
			case 0:
				return _List_Nil;
			case 1:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.a7, id]);
			case 3:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.a5, id]);
			case 2:
				var id = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.bf, id]);
			default:
				var filter = route.a;
				return _List_fromArray(
					[author$project$Internal$Route$urlLabel.dl, filter]);
		}
	}();
	return _Utils_eq(pieces, _List_Nil) ? '' : ('/' + A2(elm$core$String$join, '/', pieces));
};
var author$project$Internal$Route$conf = {db: author$project$Internal$Route$Empty, em: author$project$Internal$Route$parser, e7: author$project$Internal$Route$toString};
...
var author$project$Internal$StopWordFilter$createMyStopWordFilter = rluiten$elm_text_search$StopWordFilter$createFilterFunc(_List_Nil);
...
var rluiten$elm_text_search$Index$addDoc = F4(
	function (docRef, fieldsTokens, docTokens, index) {
		var irec = index;
		var updatedDocumentStore = A3(elm$core$Dict$insert, docRef, docTokens, irec.aU);
		...
		var allBoosts = A2(
			...
			A2(elm$core$List$map, elm$core$Tuple$second, irec.dY),
			A2(elm$core$List$map, elm$core$Tuple$second, irec.dj));
		...
		var updatedTokenStore = A3(elm$core$List$foldr, addTokenScore, irec.bp, tokenAndScores);
		return _Utils_update(
			irec,
			{aS: updatedCorpusTokens, bE: updatedCorpusTokensIndex, aU: updatedDocumentStore, a2: elm$core$Dict$empty, bp: updatedTokenStore});
	});
...
var rluiten$elm_text_search$Index$Utils$setIndexFilters = F2(
	function (_n0, listFuncs) {
		...
		return _Utils_update(
			irec,
			{
				dn: elm$core$Maybe$Just(listFuncs)
			});
	});
...
var rluiten$elm_text_search$Index$Utils$setIndexInitialTransforms = F2(
	function (_n0, listFuncs) {
		...
		return _Utils_update(
			irec,
			{
				dO: elm$core$Maybe$Just(listFuncs)
			});
	});
...
var rluiten$elm_text_search$Index$Utils$setIndexTransforms = F2(
	function (_n0, listFuncs) {
		...
		return _Utils_update(
			irec,
			{
				fc: elm$core$Maybe$Just(listFuncs)
			});
	});
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {dJ: index, d_: match, ea: number, eP: submatches};
	});
...
var rluiten$elm_text_search$Index$Utils$refExists = F2(
	function (docRef, _n0) {
		var irec = _n0;
		return A2(elm$core$Dict$member, docRef, irec.aU);
	});
var rluiten$elm_text_search$Index$add = F2(
	function (doc, index) {
		var irec = index;
		var docRef = irec.er(doc);
		if (elm$core$String$isEmpty(docRef)) {
			...
			if (A2(rluiten$elm_text_search$Index$Utils$refExists, docRef, index)) {
				...
				var _n0 = A3(
					...
					_Utils_Tuple2(index, _List_Nil),
					A2(elm$core$List$map, elm$core$Tuple$first, irec.dj));
				var u1index = _n0.a;
				...
				var _n1 = A3(
					...
					A2(elm$core$List$map, elm$core$Tuple$first, irec.dY));
				var u2index = _n1.a;
...
var rluiten$elm_text_search$Index$newWith = function (_n0) {
	var indexType = _n0.dL;
	var ref = _n0.er;
	var fields = _n0.dj;
	var listFields = _n0.dY;
	var initialTransformFactories = _n0.dN;
	var transformFactories = _n0.fb;
	var filterFactories = _n0.dm;
	return {aS: elm$core$Set$empty, bE: elm$core$Dict$empty, aU: elm$core$Dict$empty, dj: fields, dm: filterFactories, dn: elm$core$Maybe$Nothing, a2: elm$core$Dict$empty, dL: indexType, a4: rluiten$elm_text_search$Index$Defaults$indexVersion, dN: initialTransformFactories, dO: elm$core$Maybe$Nothing, dY: listFields, er: ref, bp: rluiten$trie$Trie$empty, fb: transformFactories, fc: elm$core$Maybe$Nothing};
};
...
var author$project$Internal$Search$indexBuilderforRepo = function (repos) {
	var index = rluiten$elm_text_search$ElmTextSearch$newWith(
		{
			...
			dm: _List_fromArray(
				[author$project$Internal$StopWordFilter$createMyStopWordFilter]),
			dL: 'Rakuten Open Source - Customized Stop Words v1',
			dN: rluiten$elm_text_search$Index$Defaults$defaultInitialTransformFactories,
			dY: _List_Nil,
			er: function (repo) {
				return repo.bc;
			},
			fb: rluiten$elm_text_search$Index$Defaults$defaultTransformFactories
		});
	return A2(rluiten$elm_text_search$ElmTextSearch$addDocs, repos, index);
};
var author$project$Internal$Type$Grid = 1;
var author$project$Repos$repos = _List_fromArray(
	[
		{da: 'Provides information about items listed for sale on Rakuten sites, shopping cart, and other functionality for use by developers and corporate enterprise teams.', dq: false, dx: 'http://webservice.rakuten.co.jp/sdk/', dA: 'https://github.com/rakuten-ws/', dU: '', a8: '', bc: 'Rakuten Web Service', ff: ''},
		{da: 'LeoFS is an unstructured object/data storage for the Web and a highly available, distributed, eventually consistent storage system.', dq: false, dx: 'http://leo-project.net/leofs/', dA: 'https://github.com/leo-project/leofs', dU: '', a8: 'logo/leofs.png', bc: 'LeoFS', ff: ''},
		{da: 'A Distributed Key-Value Store in Ruby.', dq: false, dx: 'http://roma-kvs.org/', dA: 'https://github.com/roma/roma', dU: '', a8: 'logo/roma.png', bc: 'ROMA', ff: ''},
		{da: 'Egison is a purely functional programming language that realizes non-linear pattern-matching against unfree data types.', dq: false, dx: 'http://www.egison.org/', dA: 'https://github.com/egison/egison', dU: '', a8: '', bc: 'Egison', ff: ''}
	]);
		...
		return _Utils_Tuple2(
			{
				...
				dl: filter,
				dK: author$project$Internal$Search$indexBuilderforRepo(author$project$Repos$repos),
				dS: key,
				dV: 1,
				bV: flags.bV,
				el: true,
				et: author$project$Repos$repos,
				fg: url,
				co: flags.co
			},
...
var author$project$Internal$Msg$OnStoreChange = function (a) {
	return {$: 10, a: a};
};
...
var author$project$Internal$Port$onStoreChange = _Platform_incomingPort('onStoreChange', elm$json$Json$Decode$string);
...
var author$project$Internal$Port$elmToLocalStorage = _Platform_outgoingPort(
	'elmToLocalStorage',
	function ($) {
...
var author$project$Internal$Port$toLocalStorage = function (data) {
	var json = elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nightMode',
				elm$json$Json$Encode$bool(data.d2))
			]));
	var string = A2(elm$json$Json$Encode$encode, 0, json);
	return author$project$Internal$Port$elmToLocalStorage(
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dr: fragment, bO: host, eo: path, b3: port_, b6: protocol, b7: query};
	});
...
var author$project$Internal$Update$commandToCloseModal = function (_n0) {
	...
	return A2(
		...
		key,
		A2(
			author$project$Internal$CommonRoute$toStringAndHash,
			author$project$Internal$Route$conf,
			author$project$Internal$Route$routeToRestoreFilter(filter)));
};
var author$project$Internal$Type$LocalStorage = function (nightMode) {
	return {d2: nightMode};
};
var author$project$Internal$Update$decoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'nightMode',
	elm$json$Json$Decode$bool,
	elm$json$Json$Decode$succeed(author$project$Internal$Type$LocalStorage));
...
var author$project$Internal$Utils$encode = function (string) {
...
var author$project$Internal$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 10:
				var ls = msg.a;
				var localStorageResult = A2(elm$json$Json$Decode$decodeString, author$project$Internal$Update$decoder, ls);
				if (!localStorageResult.$) {
					var localStorage = localStorageResult.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bV: localStorage}),
			...
			case 9:
				...
				var _n2 = function () {
					if (!response.$) {
						var repos_ = response.a;
						return _Utils_Tuple2(
							_Utils_ap(model.et, repos_),
							elm$core$Maybe$Nothing);
					} else {
						var err = response.a;
						return _Utils_Tuple2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							dd: error,
							dK: author$project$Internal$Search$indexBuilderforRepo(repos),
							et: repos
						}),
					elm$core$Platform$Cmd$none);
			case 7:
			...
			case 8:
				var url = msg.a;
				var route = A2(author$project$Internal$CommonRoute$fromUrl, author$project$Internal$Route$conf, url);
				var filter = function () {
					switch (route.$) {
						case 4:
							var filter_ = route.a;
			...
			case 0:
				var data = msg.a;
				return (data.dB === 'cover') ? _Utils_Tuple2(
					model,
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 2:
				var localStorage = model.bV;
				var newLocalStorage = _Utils_update(
					localStorage,
					{d2: !localStorage.d2});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bV: newLocalStorage}),
					author$project$Internal$Port$toLocalStorage(newLocalStorage));
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						A2(
							author$project$Internal$CommonRoute$toStringAndHash,
							author$project$Internal$Route$conf,
							(filter === '') ? author$project$Internal$Route$Empty : author$project$Internal$Route$Filter(
								author$project$Internal$Utils$encode(filter)))));
		}
	});
var author$project$Conf$css = '\n.animatedItem {\n    transition: all 100ms linear;\n}\n.animatedItem:hover {\n    transform: scale(1.7, 1.7);\n    z-index: 1;\n}\n';
var author$project$Conf$headerHeight = 120;
var author$project$Conf$maxWidth = 1200;
...
var author$project$Conf$colorPalette = function (nightMode) {
	return nightMode ? {
		aP: A3(mdgriffith$elm_ui$Element$rgb, 0.1, 0.1, 0.1),
		aR: A3(mdgriffith$elm_ui$Element$rgb, 0.2, 0.2, 0.2),
		aW: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8),
		aX: A3(mdgriffith$elm_ui$Element$rgb, 0.5, 0.5, 0.5),
		aY: A3(mdgriffith$elm_ui$Element$rgb255, 40, 40, 40),
		aZ: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
		a_: A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153),
		a8: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
		bi: A3(mdgriffith$elm_ui$Element$rgb, 0.18, 0.18, 0.18),
		bj: A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0)
	} : {
		aP: A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1),
		aR: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8),
		aW: A3(mdgriffith$elm_ui$Element$rgb, 0.3, 0.3, 0.3),
		aX: A3(mdgriffith$elm_ui$Element$rgb, 0.4, 0.4, 0.4),
		aY: A3(mdgriffith$elm_ui$Element$rgb255, 51, 51, 51),
		aZ: A3(mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
		a_: A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153),
		a8: A3(mdgriffith$elm_ui$Element$rgb255, 191, 0, 0),
		bi: A3(mdgriffith$elm_ui$Element$rgb, 0.97, 0.97, 0.97),
		bj: A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8)
	};
};
var author$project$Internal$Utils$c = F2(
	function (model, key) {
		return key(
			author$project$Conf$colorPalette(model.bV.d2));
	});
...
var mdgriffith$elm_ui$Internal$Style$classes = {cs: 'a', aL: 'atv', cv: 'ab', cw: 'cx', cx: 'cy', cy: 'acb', cz: 'accx', cA: 'accy', cB: 'acr', bv: 'al', bw: 'ar', cC: 'at', aM: 'ah', aN: 'av', cE: 's', cI: 'bh', cJ: 'b', cN: 'w7', cP: 'bd', cQ: 'bdt', ap: 'bn', cR: 'bs', aq: 'cpe', c$: 'cp', c0: 'cpx', c1: 'cpy', B: 'c', as: 'ctr', at: 'cb', au: 'ccx', C: 'ccy', ac: 'cl', av: 'cr', c5: 'ct', c6: 'cptr', c7: 'ctxt', dp: 'fcs', ds: 'fs', du: 'g', a0: 'hbh', az: 'hc', a1: 'hf', bN: 'hfp', dy: 'hv', dG: 'ic', dI: 'fr', dP: 'iml', dQ: 'it', dR: 'i', X: 'nb', bZ: 'notxt', ed: 'ol', ef: 'or', O: 'oq', ek: 'oh', b0: 'pg', b1: 'p', en: 'ppe', ew: 'ui', t: 'r', ez: 'sb', eA: 'sbx', eB: 'sby', eC: 'sbt', eE: 'e', eG: 'cap', eH: 'sev', eO: 'sk', eT: 't', eU: 'tc', eV: 'w8', eW: 'w2', eX: 'w9', eY: 'tj', aH: 'tja', eZ: 'tl', e_: 'w3', e$: 'w5', e0: 'w4', e1: 'tr', e2: 'w6', e3: 'w1', e4: 'tun', ck: 'ts', S: 'clr', fd: 'u', bq: 'wc', cp: 'we', br: 'wf', cq: 'wfp', bt: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.B);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.du);
...
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.b1);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.t);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eE);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.v)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eI.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.eI.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.t) + ('-' + (elm$core$String$fromInt(pos.c3) + ('-' + (elm$core$String$fromInt(pos.co) + ('-' + elm$core$String$fromInt(pos.W)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.eb.a) + 'px'),
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.eb.b) + 'px'),
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.cL) + 'px'),
					elm$core$Maybe$Just(
							...
							mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									eb: A2(
										...
										A2(elm$core$Tuple$mapFirst, elm$core$Basics$toFloat, shadow.eb)),
									eF: shadow.eF
								}));
					},
					focus.eD),
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dy, mdgriffith$elm_ui$Internal$Style$classes.S)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dy, mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dp, mdgriffith$elm_ui$Internal$Style$classes.S)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.dp, mdgriffith$elm_ui$Internal$Style$classes.O)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aL, mdgriffith$elm_ui$Internal$Style$classes.S)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aL, mdgriffith$elm_ui$Internal$Style$classes.O)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cE) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.t) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cE) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cE) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.t) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cE) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.as) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ar: closing, h: _List_Nil, G: _List_Nil, y: selector};
	});
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.y + ('{' + (renderValues(rule.G) + (rule.ar + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.eG + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.eT + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.eG + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.eT)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {W: height / size, eF: size, cm: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cY, adjustment.cH, adjustment.c9, adjustment.dZ]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.t) + (' / ' + (elm$core$String$fromInt(position.t + position.W) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.c3) + (' / ' + (elm$core$String$fromInt(position.c3 + position.co) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.t) + ('-' + (elm$core$String$fromInt(position.c3) + ('-' + (elm$core$String$fromInt(position.co) + ('-' + elm$core$String$fromInt(position.W)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eE))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.as, mdgriffith$elm_ui$Internal$Style$classes.C, mdgriffith$elm_ui$Internal$Style$classes.cB])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.as, mdgriffith$elm_ui$Internal$Style$classes.C, mdgriffith$elm_ui$Internal$Style$classes.cz])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.as, mdgriffith$elm_ui$Internal$Style$classes.cA])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.as, mdgriffith$elm_ui$Internal$Style$classes.cy])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eT, mdgriffith$elm_ui$Internal$Style$classes.bq, mdgriffith$elm_ui$Internal$Style$classes.az])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eT, mdgriffith$elm_ui$Internal$Style$classes.br, mdgriffith$elm_ui$Internal$Style$classes.a1])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ch : _Utils_ap(styled.ch, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.dz, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.ch : _Utils_ap(styled.ch, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.ch : _Utils_ap(rendered.ch, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.cs]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.cJ]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.ef]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.ed]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.dI]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.eE, mdgriffith$elm_ui$Internal$Style$classes.cI]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bv);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bw);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cw);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.aN + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cC);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aN + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cv);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aN + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cx);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.cE + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.t + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.ch);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var author$project$ViewBody$view = _List_fromArray(
	[
		A2(
...
var author$project$Internal$Utils$isMobile = function (model) {
	return model.co < 700;
};
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.c5 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ac)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var author$project$ViewBody$viewTagline = function (model) {
	return author$project$Internal$Utils$isMobile(model) ? A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text('Contribute to society by creating value through innovation'),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text('”'))
...
var author$project$Internal$View$viewIntroduction = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						model.bV.d2 ? 'img/backgroundDark.png' : 'img/backgroundBright.png')
					]),
				mdgriffith$elm_ui$Element$none),
				author$project$ViewBody$viewTagline(model),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				_List_fromArray(
					[
...
var rluiten$elm_text_search$Index$Utils$calcIdf = F2(
	function (_n0, token) {
		var irec = _n0;
		var docFrequency = A2(rluiten$trie$Trie$valueCount, token, irec.bp);
		var idfLocal = (docFrequency > 0) ? (1 + A2(
			elm$core$Basics$logBase,
			10,
			elm$core$Dict$size(irec.aU) / docFrequency)) : 1;
		var updatedIdfCache = A3(elm$core$Dict$insert, token, idfLocal, irec.a2);
...
var rluiten$elm_text_search$Index$Utils$idf = F2(
	function (index, token) {
		var irec = index;
		var _n0 = A2(elm$core$Dict$get, token, irec.a2);
		if (_n0.$ === 1) {
	...
	function (tf, token, expandedToken, _n0) {
		...
		var expandedTokenDocSet = A2(
			...
			A2(
				...
				A2(rluiten$trie$Trie$get, expandedToken, u1irec.bp)));
...
var rluiten$elm_text_search$Index$Vector$buildDocVector = F4(
	function (tokensLength, fieldBoosts, baseToken, _n0) {
		...
		var index = _n0.c;
		var irec = index;
		var termFrequency = ((1 / tokensLength) * elm$core$List$length(irec.dj)) * fieldBoosts;
		var expandedTokens = A2(rluiten$trie$Trie$expand, baseToken, irec.bp);
		var _n1 = A3(
			elm$core$List$foldr,
		...
		return A2(
			...
			A3(
				...
				A2(
					...
					A2(rluiten$trie$Trie$get, token, irec.bp))));
	});
	...
	function (index, docRef) {
		...
		return A2(
			...
			A2(
				...
				A2(elm$core$Dict$get, docRef, irec.aU)));
	});
...
var rluiten$elm_text_search$Index$search = F2(
	function (query, index) {
		...
		var tokenInStore = function (token) {
			return !_Utils_eq(
				A2(rluiten$trie$Trie$getNode, token, i1irec.bp),
				elm$core$Maybe$Nothing);
		};
		return elm$core$Dict$isEmpty(i1irec.aU) ? elm$core$Result$Err('Error there are no documents in index to search.') : (elm$core$String$isEmpty(
...
var author$project$Internal$Search$resultSearch = F2(
	function (index, searchString) {
		return A2(rluiten$elm_text_search$ElmTextSearch$search, searchString, index.a);
	});
var author$project$Internal$Utils$decode = function (string) {
	return A3(
...
var author$project$Internal$Search$filteredRepos = function (model) {
	var searchResults = A2(
		elm$core$Result$map,
		elm$core$Tuple$second,
		A2(
			author$project$Internal$Search$resultSearch,
			model.dK,
			author$project$Internal$Utils$decode(model.dl)));
...
var mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {cL: almostShade.cL, c4: almostShade.c4, bR: false, eb: almostShade.eb, eF: almostShade.eF};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var author$project$Internal$View$attrsRepoContainer = function (model) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			...
			A2(
				author$project$Internal$Utils$c,
				model,
				function ($) {
					return $.bi;
				})),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							(repo.a8 === '') ? mdgriffith$elm_ui$Element$none : A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$alignLeft,
							...
							A2(
								...
								{da: 'Logo', eK: repo.a8})),
							mdgriffith$elm_ui$Element$text(repo.bc)
						])),
					A2(
					mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text(repo.da)
						])),
					(repo.dx === '') ? mdgriffith$elm_ui$Element$none : A2(
						...
						]),
					{
						dT: A2(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$text(repo.dx)
								])),
						fg: repo.dx
					}),
					(repo.dU === '') ? mdgriffith$elm_ui$Element$none : A2(
					mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
						[mdgriffith$elm_ui$Element$alignBottom]),
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Language: ' + repo.dU)
						]))
				]));
	});
var author$project$Internal$View$repoCell = F2(
	function (model, repo) {
		return A2(
			mdgriffith$elm_ui$Element$link,
			author$project$Internal$View$attrsRepoContainer(model),
			{
				dT: A3(author$project$ViewRepo$view, model, 0, repo),
				fg: repo.dA
			});
	});
var author$project$Internal$View$viewFirstOne = F2(
	function (model, repos) {
		return A2(
			elm$core$List$map,
			function (repo) {
				return A2(author$project$Internal$View$repoCell, model, repo);
			},
			repos);
	});
var author$project$Internal$View$attrsRow = function (model) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			mdgriffith$elm_ui$Element$spacing(20)
...
var author$project$Internal$View$viewFirstThree = F2(
	function (model, repos) {
		if (!repos.b) {
			return _List_Nil;
		} else {
			if (!repos.b.b) {
				...
				return _List_fromArray(
					[
						A2(author$project$Internal$View$repoCell, model, x)
					]);
			} else {
				if (!repos.b.b.b) {
					var x = repos.a;
					...
					return _List_fromArray(
						[
							A2(
							mdgriffith$elm_ui$Element$row,
							author$project$Internal$View$attrsRow(model),
							_List_fromArray(
								[
									A2(author$project$Internal$View$repoCell, model, x),
									A2(author$project$Internal$View$repoCell, model, y)
								]))
						]);
				} else {
					var x = repos.a;
							...
							[
								...
								_List_fromArray(
									[
										A2(author$project$Internal$View$repoCell, model, x),
										A2(author$project$Internal$View$repoCell, model, y),
										A2(author$project$Internal$View$repoCell, model, z)
									]))
							]),
						A2(author$project$Internal$View$viewFirstThree, model, xs));
				}
			}
		}
	});
var author$project$Internal$View$viewFirstTwo = F2(
	function (model, repos) {
		if (!repos.b) {
			return _List_Nil;
		} else {
			if (!repos.b.b) {
				...
				return _Utils_ap(
					...
					A2(author$project$Internal$View$viewFirstTwo, model, xs));
			}
		}
	});
var author$project$Internal$View$viewRepos = function (model) {
	var repos = author$project$Internal$Search$filteredRepos(model);
	var length = elm$core$List$length(repos);
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		(!length) ? _List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text('No Repositories found for the filter \"' + (model.dl + '\"')))
			]) : _Utils_ap(
			_List_fromArray(
				[
					A2(
					...
					_List_Nil,
					mdgriffith$elm_ui$Element$text(
						elm$core$String$fromInt(length) + ' repositories'))
				]),
			A2(
				(model.co < 600) ? author$project$Internal$View$viewFirstOne : ((model.co < 900) ? author$project$Internal$View$viewFirstTwo : author$project$Internal$View$viewFirstThree),
				model,
				repos)));
};
var author$project$Internal$Icon$Logo_Rakuten = 9;
var avh4$elm_color$Color$RgbaSpace = F4(
	function (a, b, c, d) {
		return {$: 0, a: a, b: b, c: c, d: d};
	});
var avh4$elm_color$Color$fromRgba = function (components) {
	return A4(avh4$elm_color$Color$RgbaSpace, components.bh, components.a$, components.aQ, components.U);
};
var mdgriffith$elm_ui$Element$toRgb = function (_n0) {
	...
	var b = _n0.c;
	var a = _n0.d;
	return {U: a, aQ: b, a$: g, bh: r};
};
var author$project$Internal$Icon$elementColorToElmColor = function (elementColor) {
...
var author$project$Internal$Icon$saFill = function (cl) {
	return elm$svg$Svg$Attributes$fill(
		noahzgordon$elm_color_extra$Color$Convert$colorToHex(
			author$project$Internal$Icon$elementColorToElmColor(cl)));
};
...
var author$project$Internal$Icon$iconViewBoxAndPaths = F2(
	function (icon_, cl) {
		switch (icon_) {
			case 0:
				return _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Internal$Icon$saFill(cl),
				...
				return _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$svg$Svg$Attributes$clipPath('url(#clip0)')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											elm$svg$Svg$Attributes$d('M15.8 31.6a15.8 15.8 0 1 0 0-31.6 15.8 15.8 0 0 0 0 31.6z')
										]),
									_List_Nil),
									A2(
									elm$svg$Svg$path,
									_List_fromArray(
										[
											author$project$Internal$Icon$saFill(cl),
											elm$svg$Svg$Attributes$d('M10.86 26.27L8 23.88h20l-17.14 2.39zM14.1 22.09v-5.3h2.29l3.97 5.3h4.06l-4.8-6.4A5.9 5.9 0 0 0 16.2 5h-5.36v17.08h3.24zm0-13.85h2.11a2.65 2.65 0 1 1 0 5.3H14.1v-5.3z')
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$svg$Svg$Attributes$id('clip0')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													elm$svg$Svg$Attributes$fill(bgColor),
													elm$svg$Svg$Attributes$d('M0 0h32.1v31.7H0z')
												]),
											_List_Nil)
										]))
								]))
...
var author$project$Internal$Icon$icon = F3(
	function (icon_, cl, size) {
		var _n0 = A2(author$project$Internal$Icon$iconViewBoxAndPaths, icon_, cl);
		var viewBox = _n0.a;
		var paths = _n0.b;
...
var author$project$Internal$Msg$ToggleColorMode = {$: 2};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.au + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.C + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.eC + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bZ)))))),
						A2(
							elm$core$List$cons,
...
var author$project$ViewFooter$view = function (model) {
	var alignR = author$project$Internal$Utils$isMobile(model) ? mdgriffith$elm_ui$Element$centerX : mdgriffith$elm_ui$Element$alignRight;
	var alignL = author$project$Internal$Utils$isMobile(model) ? mdgriffith$elm_ui$Element$centerX : mdgriffith$elm_ui$Element$alignLeft;
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[
					A2(
					author$project$Internal$Utils$isMobile(model) ? mdgriffith$elm_ui$Element$column : mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												dT: mdgriffith$elm_ui$Element$text('Rakuten Technology'),
												fg: 'https://github.com/rakutentech'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												dT: mdgriffith$elm_ui$Element$text('Rakuten Front-end'),
												fg: 'https://github.com/rakuten-frontend'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												dT: mdgriffith$elm_ui$Element$text('Rakuten Web Service'),
												fg: 'https://github.com/rakuten-ws'
											})
										])),
									A2(
									mdgriffith$elm_ui$Element$el,
									...
									_List_fromArray(
										[
											...
											_List_Nil,
											{
												dT: mdgriffith$elm_ui$Element$text('Rakuten Developers'),
												fg: 'https://webservice.rakuten.co.jp/'
											}),
											A2(
											mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												dT: mdgriffith$elm_ui$Element$text('Rakuten RapidAPI'),
												fg: 'https://api.rakuten.co.jp/'
											})
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									{
										dT: A3(
											author$project$Internal$Icon$icon,
											9,
											A2(
												author$project$Internal$Utils$c,
												model,
											...
											32),
										fg: 'https://global.rakuten.com/corp/'
									}),
									A2(
									mdgriffith$elm_ui$Element$el,
									_List_fromArray(
									...
									mdgriffith$elm_ui$Element$text('© Rakuten, inc.')),
									A2(
										...
										]),
									{
										dT: A2(
											...
											_List_fromArray(
												[
													mdgriffith$elm_ui$Element$text('Night mode'),
													A2(
													mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
															...
															A2(
																...
																_List_fromArray(
																	[
																		...
																		mdgriffith$elm_ui$Element$htmlAttribute(
																		A2(elm$html$Html$Attributes$style, 'transition', 'all 100ms linear')),
																		mdgriffith$elm_ui$Element$Background$color(
										...
										ee: elm$core$Maybe$Just(author$project$Internal$Msg$ToggleColorMode)
									})
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							{
								dT: mdgriffith$elm_ui$Element$text('About'),
								fg: 'https://global.rakuten.com/corp/'
							}),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								dT: mdgriffith$elm_ui$Element$text('Careers'),
								fg: 'https://rakuten.careers/'
							}),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								dT: mdgriffith$elm_ui$Element$text('Contact'),
								fg: 'mailto:dev-opensource@mail.rakuten.com'
							})
						]))
				])));
};
var author$project$Conf$headerHeightSmall = 80;
var author$project$Conf$paddingDesktop = 20;
var author$project$Conf$paddingMobile = 8;
var author$project$Internal$Utils$paddingResponsive = function (model) {
	return author$project$Internal$Utils$isMobile(model) ? author$project$Conf$paddingMobile : author$project$Conf$paddingDesktop;
};
var author$project$Conf$iconSize = 32;
var author$project$Internal$Icon$Icon_Close = 2;
var author$project$Internal$Msg$ChangeFilter = function (a) {
	return {$: 4, a: a};
};
var author$project$ViewHeader$filterText = function (model) {
	return author$project$Internal$Utils$isMobile(model) ? 'Filter' : 'Filter by name, description or language';
};
	...
	function (textInput, attrs, textOptions) {
		...
		var _n0 = function () {
			...
			if (!_n1.$) {
				...
				var _n3 = A3(
									...
									case 8:
										...
										if (_n5.$ === 1) {
											return _Utils_update(
												found,
												{
													k: A2(elm$core$List$cons, attr, found.k),
					...
					{k: _List_Nil, az: elm$core$Maybe$Nothing, aB: elm$core$Maybe$Nothing, aC: elm$core$Maybe$Nothing, aD: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.aC;
				var heightContent = _n3.az;
				var maybeSpacing = _n3.aD;
				var adjustedAttributes = _n3.k;
				var maybeBorder = _n3.aB;
							...
							[
								...
								if (maybePadding.$ === 1) {
									...
									return mdgriffith$elm_ui$Element$paddingEach(
										{
											cS: A2(elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											dW: l,
											ev: r,
											e8: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4(mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.eT, spacing, maybePadding, maybeBorder);
									} else {
										return mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.en)),
						...
						elm$core$List$concat(
							_List_fromArray(
								[
									...
									[
										mdgriffith$elm_ui$Element$Input$focusDefault(attrs),
										mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.dT)
									]),
									inputAttrs,
									behavior
								])),
		...
		return A3(
			...
			A2(
				...
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.dT) ? mdgriffith$elm_ui$Internal$Model$NoAttribute : mdgriffith$elm_ui$Element$spacing(5),
...
var author$project$ViewHeader$filterInputText = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				{
					dT: mdgriffith$elm_ui$Element$Input$labelHidden(
						author$project$ViewHeader$filterText(model)),
					ec: author$project$Internal$Msg$ChangeFilter,
					ep: elm$core$Maybe$Just(
						A2(
							...
							mdgriffith$elm_ui$Element$text(
								author$project$ViewHeader$filterText(model)))),
					eT: author$project$Internal$Utils$decode(model.dl)
				}),
				(elm$core$String$length(model.dl) > 0) ? A2(
				mdgriffith$elm_ui$Element$Input$button,
				_List_Nil,
				{
					dT: A3(
						...
						author$project$Conf$iconSize),
					ee: elm$core$Maybe$Just(
						author$project$Internal$Msg$ChangeFilter(''))
				}) : mdgriffith$elm_ui$Element$none
			]));
};
var author$project$Internal$Icon$Logo_R = 10;
...
var author$project$ViewHeader$logo = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Internal$Utils$isMobile(model) ? A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$moveDown(0)
					]),
				A3(
					author$project$Internal$Icon$icon,
					10,
				...
				A3(
					...
					30)),
				(author$project$Internal$Utils$isMobile(model) && (model.dl !== '')) ? mdgriffith$elm_ui$Element$none : A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$color(
				...
				mdgriffith$elm_ui$Element$text('Open Source'))
			]));
};
...
var author$project$ViewHeader$view = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$htmlAttribute(
					A2(elm$html$Html$Attributes$style, 'transition', 'all 200ms linear'))
				]),
			model.el ? _List_fromArray(
				[
					mdgriffith$elm_ui$Element$height(
					mdgriffith$elm_ui$Element$px(author$project$Conf$headerHeight))
				]) : _List_fromArray(
				[
					mdgriffith$elm_ui$Element$height(
					mdgriffith$elm_ui$Element$px(author$project$Conf$headerHeightSmall)),
					mdgriffith$elm_ui$Element$Border$shadow(
					{
						cL: 10,
						c4: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2),
						eb: _Utils_Tuple2(0, 0),
						eF: 5
					})
				])),
		A2(
			...
			_List_fromArray(
				[
					...
					author$project$Internal$Utils$paddingResponsive(model)),
					mdgriffith$elm_ui$Element$htmlAttribute(
			...
			_List_fromArray(
				[
					author$project$ViewHeader$logo(model),
					author$project$ViewHeader$filterInputText(model)
				])));
};
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{dp: elm$core$Maybe$Nothing, dy: elm$core$Maybe$Nothing, d0: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.ew, mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.eE]))),
...
var author$project$Internal$View$view = function (model) {
	var route = A2(author$project$Internal$CommonRoute$fromUrl, author$project$Internal$Route$conf, model.fg);
				...
				mdgriffith$elm_ui$Element$layoutWith,
				{
					ej: _List_fromArray(
						[
							...
							{cG: elm$core$Maybe$Nothing, cO: elm$core$Maybe$Nothing, eD: elm$core$Maybe$Nothing})
						])
				},
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$inFront(
						author$project$ViewHeader$view(model))
					]),
				A2(
					mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$paddingEach(
							{cS: 0, dW: 0, ev: 0, e8: author$project$Conf$headerHeight}),
							mdgriffith$elm_ui$Element$spacing(10),
							mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
						]),
					_List_fromArray(
						[
							...
							A3(
								...
								_List_fromArray(
									[
										elm$html$Html$text(author$project$Conf$css)
									]))),
							(model.dl === '') ? author$project$Internal$View$viewIntroduction(model) : mdgriffith$elm_ui$Element$none,
							author$project$Internal$View$viewRepos(model),
							function () {
							var _n0 = model.dd;
							if (!_n0.$) {
								var errorHttp = _n0.a;
								return A2(
									...
									_List_fromArray(
										[mdgriffith$elm_ui$Element$centerX]),
									mdgriffith$elm_ui$Element$text('Error while loading repositories...'));
							} else {
...
var author$project$Internal$Main$main = elm$browser$Browser$application(
	{
		dM: author$project$Internal$Init$init,
		eg: author$project$Internal$Msg$UrlChanged,
		eh: author$project$Internal$Msg$LinkClicked,
		eQ: function (model) {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						elm$browser$Browser$Events$onResize(author$project$Internal$Msg$OnResize),
						author$project$Internal$Port$pageInTopArea(author$project$Internal$Msg$PageInTopArea),
						ohanhi$keyboard$Keyboard$ups(author$project$Internal$Msg$KeyUp),
						author$project$Internal$Port$onStoreChange(author$project$Internal$Msg$OnStoreChange)
					]));
		},
		fe: author$project$Internal$Update$update,
		fh: author$project$Internal$View$view
	});
			...
			return A2(
				...
				A2(
					...
					A2(
						...
						A2(elm$json$Json$Decode$field, 'nightMode', elm$json$Json$Decode$bool))));
		},
