...
iconViewBoxAndPaths icon_ cl =
    case icon_ of
        ...
        Logo_R ->
            ...
            ( "0 0 33 32"
            , [ Svg.g
                    [ SA.clipPath "url(#clip0)" ]
                    [ Svg.path [ SA.fill bgColor, SA.d "M15.8 31.6a15.8 15.8 0 1 0 0-31.6 15.8 15.8 0 0 0 0 31.6z" ] []
                    , Svg.path [ saFill cl, SA.d "M10.86 26.27L8 23.88h20l-17.14 2.39zM14.1 22.09v-5.3h2.29l3.97 5.3h4.06l-4.8-6.4A5.9 5.9 0 0 0 16.2 5h-5.36v17.08h3.24zm0-13.85h2.11a2.65 2.65 0 1 1 0 5.3H14.1v-5.3z" ] []
                    ]
              , Svg.defs
                    []
                    [ Svg.clipPath [ SA.id "clip0" ]
                        [ Svg.path [ SA.fill bgColor, SA.d "M0 0h32.1v31.7H0z" ] []
                        ]
                    ]
              ]
            )
